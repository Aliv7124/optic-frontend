...
const stripePromise = loadStripe("pk_test_51SnxUrH9MvXtyWo2TwoGEqxHHXTNvGIbrmEyU5ueugVFu5p16Jwdci7pNOdTVKlZtTCnmZQDoalCA5bCKXkLXtxu00ftsmtN8G");
...
const CheckoutForm = ({ clientSecret, product, lensType, prescription }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      {!paid && <PaymentElement className="mb-3" />}
      {paid && <div className="alert alert-success">Order placed successfully</div>}
      <button className="btn btn-dark w-100" disabled={loading || paid}>
...
const Checkout = () => {
  ...
  return (
    <div className="container mt-5" style={{ maxWidth: 500 }}>
      ...
      <p><strong>Lens Type:</strong> {lensType || "None"}</p>
      <p><strong>Prescription:</strong> {prescription ? "Uploaded" : "Not uploaded"}</p>
